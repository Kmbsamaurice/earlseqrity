...
<body id="homepage">
    ...
    <header id="header">
        <div class="nav-wrapper container">
            ...
            <div class="header-logo"> <a href="#" class="nav-logo">404 Error</a> </div>
        ...
        <div class="error-page">
            <div class="in-error-page">
                <div class="in-in-error-page">
                    <h1>404</h1>
                    <p> Sorry</br>This Page is under construction for a better shopping experience.</br>
                        </br> Thank you for using Earl Seqrity!</br>
                    </p>
                    <p> <a href="<?php echo base_url('/');?>" class="btn">Back to home</a> </p>
                </div>
            </div>
        </div>
    </div>