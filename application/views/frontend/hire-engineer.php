...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Hire an Engineer</a>
  </div>
...
<!-- CONTENT -->
<div id="page-content">
        <div class="row card" onclick="location.href='<?php echo site_url('engineer-profile');?>';">
         ...
         <div><b>Eng. Samuel Kakembo</b></div>
         <div><i class="far fa-star" aria-hidden="true"> Rating 4.5</i></div>
         <div> <button class="profile-link" type="submit">View Profile</button></div>
...
<div class="mobile-bottom-bar2">
    <div class="row ">
        <div class="col s12 container">
            <div class="col s6">
                <button class="continue-link" type="submit">Hire Now</button>
            </div>
            <div class="col s6">
                <a href="checkout.html"><button class="checkout-link"><i class="fas fa-phone-volume"></i> Call Now</button></a>
