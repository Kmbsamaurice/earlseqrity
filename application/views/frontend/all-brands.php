...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->All Brands</a>
  </div>
...
<ul id="nav-mobile-account" class="side-nav">
  ...
  <li>
    <a href="<?php echo base_url('terms-and-conditions');?>"><i class="fas fa-star"></i>Terms and Conditions</a>
  </li>
  <li>
...
<div class="section product-item si-featured">
  <div class="container">
   ...
   <?php //if($brand): var_dump($brand->num_rows());endif; exit();?>
        <!-- Product item-->
