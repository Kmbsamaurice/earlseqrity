...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->seller</a>
  </div>
...
<div id="page-content">
  <div class="contact-wrap theme-form">
    <div class="container">
      ...
      <div class="row">
      <form class="col s12" action="<?php echo base_url('seller');?>" method="post">
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="location" type="text"  name='location' class="validate" value="<?php echo set_value('location');?>">
