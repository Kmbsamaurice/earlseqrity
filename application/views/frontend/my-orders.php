            ...
            <div class="wish-box">
              <div class="wi-img">
                <div class="wi-img-product">
                    <img src="<?php echo base_url('assets/frontend/img/cam.png');?>" alt="img">
                </div>
              </div>
              <div class="wi-name">
                <div class="win-top">
                  <div class="win-title">HIK Vision Dome Camera</div>
                  <div class="win-price">(Ugx) 6.00</div>
                  <div class="win-price">Cash on Delivery</div>
                  <div class="win-price">12-01-2020</div>
                </div>
              </div>
              <div class="wi-remove">
                <a href="#">Qty: 1</i></a>
