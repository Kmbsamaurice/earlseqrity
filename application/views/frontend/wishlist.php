...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Wish List</a>
  </div>
        ...
        <div class="row wish-item">
          <div class="col s12">
            <div class="wish-box">
              ...
              <div class="wi-name">
                <div class="win-top">
                  <div class="win-title"><?php echo $row["product"];?></div>
                  <div class="win-price">UGX.<?php echo number_format($row["price"]);?></div>
                  <div class="win-info"  onclick="location.href='<?php echo site_url('details/'.$row['slug']);?>';">View Details</div>
                </div>
              </div>
              <div class="wi-remove">
                <form action="<?php echo site_url('wishlist/delete/'.$row['product_id']);?>" method="post">
                  <input type="hidden" value="<?php echo $row["product_id"];?>">
                  <a href="<?php echo site_url('wishlist/delete/'.$row['product_id']);?>"><i class="far fa-times-circle"></i></a>
                </form>
              </div>
