...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Get Quotation</a>
  </div>
...
<div id="page-content">
  <div class="contact-wrap theme-form">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <div class="section-title">Get your Quotation Instantly.</div>
        </div>
      </div>
      ...
      <form class="col s12" action="<?php echo base_url('get-quotation');?>" method="post">
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <select name="project" id="project" class="validate">
            ...
            <p class='text-danger'><?php echo form_error('project');?></p>
          </div>
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
