...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Payment</a>
  </div>
...
<div id="page-content" class="shipping-checkout-page">
  <div class="cart-page">
    <div class="container">
      ...
      <div class="row">
      <form class="col s12" action="<?php echo base_url('payment-details');?>" method="post">
          <div class="payment-method-wrap ck-box">
            ...
            <div class="row">
              <div class="col s12 m12 l12 ">
                <p>
                  <input class="with-gap" name="payment_method" type="radio" id="test1" value="Cash On Delivery"/>
            ...
            <div class="row">
              <div class="col s12 m12 l12 ">
                <p>
                  <input class="with-gap" name="payment_method" type="radio" id="test2" value="Mtn MoMoPay"/>
                  <label for="test2">MTN MoMoPay</label>
                </p>
              </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4 center">
                <input class=" btn" value="CONFIRM" type="submit"></div>
            </div>
        </div> 
    </form>
    </div>
