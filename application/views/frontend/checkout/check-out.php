...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Checkout</a>
  </div>
...
<ul id="nav-mobile-account" class="side-nav">
  ...
  <?php if($this->session->userdata('id') || $this->session->userdata('shipping_id')):?>
   <li>
...
<?php 
	if(!$this->session->userdata('id')):
        ...
        Please first signin to checkout.</div>');
        redirect('sign-in'); 
  endif;
...
<div id="page-content" class="shipping-checkout-page">
  <div class="cart-page">
    <div class="container">
      ...
      <div class="row">
        <form class="col s12" action="<?php echo base_url('check-out');?>" method="post">
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="firstname" type="text" name='firstname' class="validate" value="<?php echo $customer['first_name'];?>" readonly>
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="lastname" type="text" name='lastname' class="validate" value="<?php echo $customer['last_name'];?>" readonly>
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="email" type="text" name='email' class="validate" value="<?php echo $customer['email'];?>" readonly>
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="phone" type="text" name='phone' class="validate" value="<?php echo $customer['phone'];?>" readonly>
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
                <div style="color:#ed502e;">Delivery Address *</div>
              <input id="location" type="text" name='address' class="validate" value="<?php echo set_value('address');?>">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4 center">
              <input class=" btn" value="CHECKOUT" type="submit"></div>
          </div>
          </div> 
        </form>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAzmSYQImzuAtPLfvk9QemjMBBvyRSciv8&libraries=places&callback=activatePlacesSearch"></script>