...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Engineers</a>
  </div>
  ...
  <div class="categorylist-page">
    <div class="container">
      <div class="box-category-list">
        <!-- item -->
        <div class="row category-item" onclick="location.href='<?php echo site_url('hire-engineer');?>';">
          <div class="col s12">
            <div class="category-box">
              ...
              <div class="cat-name">
                <div class="cat-top">
                  <div class="catg-title">Eng.Samuel Kakembo</div>
                  <div class="cat-info">CCTV cameras, Alarms, Bio...</div>
                </div>
              </div>
              <div class="cat-more">
