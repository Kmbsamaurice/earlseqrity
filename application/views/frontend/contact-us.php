...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Contact Us</a>
  </div>
...
<ul id="nav-mobile-account" class="side-nav">
  ...
  <?php if($this->session->userdata('id')):?>
    <div class="li-profile-info">
      ...
      <div class="balance">
        <span onclick="location.href='<?php echo site_url('profile');?>">Profile</span>
      </div>
    </div>
...
<div id="page-content">
  <div class="login-form">
    <div class="container">
      ...
      <div class="row">
        <form class="col s12" action="<?php echo base_url('contact-us');?>" method="post">
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <input id="subject" type="text" name='subject' class="validate" value="<?php echo set_value('subject');?>">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <textarea id="message" name='message' class="materialize-textarea"><?php echo set_value('message');?></textarea>
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4 center">
              <input class=" btn" value="SEND MESSAGE" type="submit"></div>
          </div>
          </div> 
          </div>
        </form>
