...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Login</a>
  </div>
  ...
  <div class="login-form">
    <div class="container">
     ...
     <?php echo $this->session->flashdata('message');?>
      <div class="row">
        <form class="col s12" action="<?php echo base_url('sign-in');?>" method="post">
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4 center">
              <input class="btn" value="LOG IN" type="submit"></div>
          </div>
        </form>
      </div>
      ...
      <div class="row">
        <div class="col s12 center">
           Don't have an Account ? <a href="<?php echo base_url('sign-up');?>">Sign Up</a>
        </div>
      </div>
    </div>
  </div>
