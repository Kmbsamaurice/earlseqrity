...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Forgot Password</a>
  </div>
...
<ul id="nav-mobile-account" class="side-nav">
  ...
  <li>
    <a href="https://play.google.com/store/apps/details?id=com.earlcommunications.earlcommunications"><i class="fas fa-star"></i>Rate Us</a>
  </li>
  <li>
...
<!-- END SIDENAV ACCOUNT--></nav><!-- CONTENT -->
<div id="page-content">
  <div class="login-form">
    <div class="container">
     ...
     <?php echo $this->session->flashdata('message');?>
      <div class="row">
      <form class="col s12" action="<?php echo base_url('forgot-password');?>" method="post">
          <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4 center">
              <input class="waves-effect waves-light btn" value="SEND LINK " type="submit"></div>
          </div>
          <div class="row fp-text">
          <div class="col s12">
            <div class="forgot-password-link">
              <a href="<?php echo base_url('sign-in');?>">Back to login</a>
            </div>
          </div>
        </div>
        </form>
