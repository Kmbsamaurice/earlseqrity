...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Reset Password</a>
  </div>
...
<div id="page-content">
  <div class="login-form">
    ...
    <?php echo $this->session->flashdata('message');?>
      <div class="row">
      <form class="col s12" action="<?php echo base_url('change-password');?>" method="post">
        <p>password reset for <?php echo $this->session->userdata('reset_email');?></p>
        <div class="row">
