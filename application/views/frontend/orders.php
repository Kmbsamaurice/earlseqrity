...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->My Orders</a>
  </div>
  ...
  <div-- class="orders-page">
    ...
    <?php echo $this->session->flashdata('message');?>
      <div class="box-order-list">
       <?php $customers = $this->Order_model->customer_order(); ?>
        ...
        <div class="row order-item">
          <div class="col s12">
            <div class="order-box">
              <div class="or-img">
                <div class="or-img-product">
                    <img src="<?php echo base_url('assets/backend/images/uploads/products/').$row->image1;?>" alt="img">
                </div>
              </div>
              <div class="or-name">
                <div class="ord-top">
                  <div class="ord-title"><?php echo $row->product;?></div>
                  <div class="ord-price">UGX <?php echo number_format($row->price);?></div>
                  <div class="ord-price"><?php echo $row->payment_method;?></div>
                  <div class="ord-price"><?php echo date("M d, Y h:i A", strtotime($row->date_created));?></div>
                  <div style="color:#00b14f; font-weight:bold; font-size:10px;">
                  <?php 
              ...
              <div class="ord-qty">
                Qty: <?php echo $row->sold_quantity;?>
              </div>
