...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Logistics</a>
  </div>
...
<div id="page-content">
  <div class="contact-wrap theme-form">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <div class="section-title">Become a logistics service provider.</div>
        </div>
      </div>
      <?php echo $this->session->flashdata('message');?>  
      <div class="row">
      <form class="col s12" action="<?php echo base_url('logistics-service-provider');?>" method="post">
        <div class="row">
          ...
          <div class="row">
            <div class="input-field col s12 m6 l4 offset-m3 offset-l4">
              <select name="transport" id="transport" class="validate">
                <option value="" >choose transport means</option>
                <option value="car" >Car</option>
                <option value="motorcycle" >Motorcycle</option>
              </select>
              <label for="transport">Transport Means(vehicle/motorcycle)</label>
            </div>
            <p class='text-danger'><?php echo form_error('transport');?></p>
          </div>
          <div class="row">
