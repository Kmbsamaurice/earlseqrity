...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->Search Results</a>
  </div>
      ...
      <div class="row row-no-margin">
          ...
          <div class="col s6 m4 l3 col-produc">
              <div class="box-product">
                <div class="bp-top">
                  ...
                  <div class="item-info"><?php echo word_limiter($row["product"],3);?></div>
                  <div class="price">
                     (Ush) <?php echo number_format($row["price"]);?>
                  </div>
        ...
        <?php else: ?>
            <div class="col s12 container">
                ...
                There were no search results found for <?php echo $search_string;?><br>
                Make sure the search words are spelled correctly.<br>use different keywords.
                </div>
            </div>
        <?php endif;?>
    </div>
