...
<div class="nav-wrapper container">
  ...
  <div class="header-logo">
    <a href="#" class="nav-logo"><!--i class="fab fa-envira"></i-->sales consultant</a>
  </div>
...
<div id="page-content">
  <div class="contact-wrap theme-form">
    <div class="container">
      <div class="row">
        <div class="col s12">
          <div class="section-title">Become a sales consultant.</div>
        </div>
      </div>
      <?php echo $this->session->flashdata('message');?>  
      <div class="row">
      <form class="col s12" action="<?php echo base_url('sales-consultant');?>" method="post">
        <div class="row">
