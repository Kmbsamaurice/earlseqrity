<div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit <?php echo $brand["brand"];?></li>
        </ol>
          ...
          <?php echo form_open_multipart('admin/brand/'.$brand["slug"]);?>
            <div class="form-row">
               ...
               <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="brand" id="brand" placeholder="brand" value="<?php echo $brand['brand'];?>">
               ...
               <div class="form-group col-md-4">
                  <div class="form-group row">
                     <div class="col-sm-6">
                        ...
                        <img src="<?php echo base_url('assets/backend/images/uploads/icons/').$brand['icon'];?>"  alt="image" class="profile-pic rounded-circle" width="120px">
                     </div>
                  </div>
               </div>
               ...
               <div class="file-upload">
                  <div class="image-upload-wrap">
                     <input type="hidden" name="old_image" value="<?php echo $brand['icon'];?>" >
