...
<body id="homepage">
        ...
        <div class="nav-wrapper container">
            <div class="header-menu-button">
                <a href="#" data-activates="nav-mobile-category" class="button-collapse" id="button-collapse-category">
                    <div class="cst-btn-menu"> <i class="fas fa-align-left"></i> </div>
                </a>
            </div>
            <div class="header-logo"> <a href="<?php echo base_url('brands');?>" class="brand-link">Shop By Brand</a> </div>
            ...
            <div class="header-icon-menu cart-item-wrap">
                <a href="<?php echo base_url('new-products');?>"> <i class="fas fa-bell"></i> <span class="new-item">NEW</span> </a>
            </div>
        </div>
    </header>
    <nav>
  ...
  <li>
   ...
   <!--li>
    <a href="#"><i class="fas fa-truck "></i>My Orders</a>
  </li-->
